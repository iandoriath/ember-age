...
- **A Jedi's word**, which out here is the only Republic writ that can't be forged.
- **Training** — for the very young. For an adult who bends luck, they offer watching.
- **Authentication** of Jedi relics and the [lore fragments](../mechanics/lore-fragments.md) that carry the Jedi tag — the Temple's archive is the one that was never scattered.
- **Protection** from things they do not believe exist.
