...
Say the stakes plainly through an NPC's mouth (any dockhand): a relit beacon means a **first-lighting fee**, salvage rights, and a corridor of worlds nobody has priced in ninety years — *for whoever gets there and gets it certified.* Cut to the scramble.
...
@@action:fragment {"name":"Grandmother Osk's rutter, page 40","form":"rutter","tag":"Civic","question":"Who lit Vesta-9?","claim":"the lane was never fully dark","holder":"crew","status":"trusted"}@@
...
> The station hangs where the charts promised, and it is lit — running lights, docking ring, the long lattice of the beacon mast all burning like a festival. Under everything, on every band, the carrier hums: one clear note repeating its name to a galaxy that stopped listening. Nothing about it looks sixty years dead. Something about it looks *swept*.

**Occupancy timeline** — who is where, keyed to the Scene 2 ladder:

| When | On station |
|---|---|
| Before anyone | @@npc:Keeper Adressa Vhail@@, kneeling at the beacon core, praying. No ship anyone can find. She answers every "how" with a psalm about doors. |
| The crew's arrival | Per the outcomes ladder — first, second, or last. |
| +40 minutes (or already there) | The @@npc:BNS Steadfast, Bastion-pattern Patrol Sloop@@ arrives off its fleet tender's clamps, runs out its guns, and broadcasts: all vessels stand to for inspection under the Corridor Security Act — a law the Admiralty passed for itself. |
...
**Running order.** Let the scene breathe in this sequence, whatever the arrival math: (1) the crew and the empty, humming station — and Vhail, who does not look up; (2) the *Steadfast*'s broadcast, which turns every hopeful in the swarm into an audience; (3) the inspection; (4) Nerra's docking request, timed to interrupt whatever is tensest; (5) certification. Scene 4 detonates wherever the inspection reaches the aft hold.
...
|---|---|---|---|
| **Wants** | The core treated as a shrine — no slicing, no salvage claim on the station — and the crew's honest account of their approach. | All vessels stand to: manifests, inspection — and one signed line in his log that this corridor "requires naval protection." | To certify the relight with the crew signed as witnesses of record, and their observations of who lit it. |
...
**Poking at the light.** Someone will examine the core — let them. **Average Mechanics or Computers** establishes three facts, delivered flatly: the failsafes were released *from inside*, in the correct order, with no forced panels; the wake sequence used valid guild handshake codes; and whoever did it cleaned up afterward. Say all three and move on — do not explain. (GM only: this is the session's one hard clue toward the Conclave rigging. Vhail did not do this, whatever the players conclude, and Nerra goes noticeably quiet if shown the handshake logs.)
