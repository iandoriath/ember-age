...
*The GM-screen module for hop 1. Run the session from this page, one scene at a time — it assumes you remember broad strokes, not details: every name is introduced and every number is stated where you need it. Marked names open stat blocks. **Branch-safe**: no particular Session One outcome is assumed — collect what your table actually did in the carry-forward table and run everything else as written.*

## What you need to know (even if you read nothing else)

**Where we are.** The crew is flying the first dead leg past Vesta-9 toward **Enarc** — hop 1 of the dark Duros Space Run. The Lamplighters' guild posts cash prizes for relighting dead beacons; the advance stalled five years on unfindable Vesta-9, Vesta-9 lit itself (Session One), and the guild instantly posted the next prize: **Enarc, 8,000 scrip** — paperwork dated, suspiciously, *before* Vesta-9's certificate cleared. A relight pays only if a guild observer certifies it; the crew likely holds a **witness charter** (250 scrip per certified lighting), and Chartmistress Bel Nerra — the guild's certifier for this corridor — is **a day behind them** and arrives in time for the certification scene.

**The twist of the night: Enarc is a hermit kingdom.** When the Run went dark, a minor Hutt with no standing in the wider clan-economy realized darkness was the one market he could corner. **Sorulba the Anchor** closed the junction, crowned himself its anchor, and has spent forty years running a small, sealed, *hedonistic* kingdom — court festivals while the gantries rust, subjects who need exit permits they never get, races and feasts as the bread-and-circuses of a state going nowhere on purpose. He is not a power. He is a weak king whose whole reign depends on the door staying shut, and he knows it. And the kingdom's door swings one way: **anyone may arrive; no one leaves without the king's leave** — and in forty years he has granted almost none. That is why the Run knows nothing of Enarc even though the junction sits on every old chart: the strays and smugglers who found the closed kingdom never came back to describe it. Run-side spacers put it plainly — *Enarc eats ships.* Its one foreign relationship runs the *other* way — quiet relations with the **Naboo Admiralty** down the Enarc Run (call it **the Naboo lane** at the table), two closed states discreetly trading, the embassy's personnel exempted by treaty. And the beacon mast on the palace spine is *maintained, polished, and off*: the king keeps it perfect as proof he could open the door any day he pleases. He never has.

**Tonight is the kingdom's opening crisis, live.** The beacon prize has brought outside hulls to the closed junction for the first time in decades — @@npc:Captain Ferro Skell@@ got there first, a couple of gold-rush crews behind him, then the *Larksong*, then the crew — and every one of them is now inside the one-way door, counting days. Skell understood the rule fastest, which is why he is spending the crew's biography like currency: he is buying his way toward an exit visa. The court is overwhelmed, fascinated, and split: Sorulba wants the gates sealed and the visitors gone; **Jeeda the Younger** has run the numbers and wants the kingdom *open*. The crew arrives carrying the one thing neither Hutt can print: guild paper that can make a relight legal. And the king is *toppleable tonight* — his throne stands on four pillars the night's own scenes can knock down (Scene 5, *The Anchor Slips*); if the table wants a coup, the module is built to give them one. And at the center of it all sits the session's centerpiece — this is the campaign's **first beacon the crew lights with their own hands** (Vesta-9 lit itself). Protect Scene 4.

**The cast, one line each** *(stats in brackets)*:

- **@@npc:Sorulba the Anchor@@** — the weak king; wants the beacon dark and his kingdom closed; never leaves the dais; his word is good and priced. He speaks to outsiders only through Vopp — being addressed directly is a privilege he sells. *(Lanes & Ledgers)*
- **@@npc:Jeeda the Younger@@** — young Hutt, the court's "auditor," the opening faction; wants the beacon lit with the kajidic named **port authority of record**. *(Lanes & Ledgers)*
- **@@npc:Kajidic Enforcers@@** — the palace guard; commercial, unhurried, stun-first. *(Lanes & Ledgers)*
- **Scale-Master Vopp** — the king's voice, clerk, and spymaster: the scales, the picket log, the court record. Unstatted social terrain; has heard everything twice.
- **Draz** — the court's swoop champion, the king's pride; unstatted — borrow Swoop Ace "Kettle" Maro's block. *(Out on the Run)*
- **Purser-Lieutenant Ansa Breck** — the Naboo Admiralty's envoy at the kingdom's one embassy; **treaty wing** (wants the lane lit, tariffed low, friendly). Unstatted — borrow Lieutenant-at-Writs Calloway. *(Republic & Admiralty)*
- **Lieutenant Dray Kollen** — Breck's escort; **Founding cadre** (would keep the junction a chokepoint until the fleet can hold it — the king's side tonight, ironically). Mute background: he drills his marines on the embassy pad in public view and lets the image talk. *(borrow Admiralty Marines)*
- **@@npc:Captain Ferro Skell@@** + @@npc:Skell's crew@@ and @@npc:The Overdue, debt-bought Ghtroc 720@@ — the crew's enemy peer from Session One. He landed first, and the first thing he sold the court was *the crew's biography*. *(Vesta-9 & the Crew's Orbit)*
- **@@npc:Captain Vess Marrow@@** + the @@npc:Larksong crew@@ — the friendly rival, champion of the last paid prize; the season wager is live. *(Vesta-9 & the Crew's Orbit)*
- **@@npc:Chartmistress Bel Nerra@@** — the guild certifier, a day behind. *(Vesta-9 & the Crew's Orbit)*
...
|---|---|
| Named the stranger on the record — testified that an unknown hand lit Vesta-9 deliberately | The finding empowers the Founding wing: Kollen holds a mandate as well as an escort post, Breck's soft offer hardens, and the *Steadfast*'s tender is scheduled for Enarc within weeks. The court hears of it and reads it correctly: the outside is already arguing over who polices *them*. |
| Certified it clean — "unknown hand, lane clear" | Guild doors are warm — and if Nerra's fine print named the guild *charting authority for the corridor*, the crew now carries that sovereignty claim into a king's court whether they like it or not. Sorulba has read the certificate. He quotes it. |
| Backed Skell's lien | The court already holds his *notarized* version — the crew's names co-sworn on the founding claim — so correcting the record at Enarc now smells of perjury, and the court enjoys the smell. Skell's exit-visa fund got its down payment from their cut. |
| Handed the evidence to Vhail | A Vigil circuit ship shadows the crew's transponder a day behind. It does not hail. It is taking notes — and its first question about the strange navy is the campaign's in miniature: a fleet full of order and empty of the Force, now census-curious about the gifted. |
| Sold Osk's page — or the book's address | The Scrub is ahead of them: the kingdom's pickets logged a ghost transit crossing the far sky, outbound up the Run, three days ago — unanswered, unhailed. The crew is no longer opening doors; they are following someone through them. |
| Kept the page (or hold the book) | Osk's margins cover the junction: the true approach past the dead buoys (boost die on the jump), and a note in her hand — *"Enarc's scales are honest. The scale-master is not."* |
| Returned to Osk / hold the full story | Her testimony names this place: the "antiquarians'" survey she flew skirted the closed kingdom once, ran dark, and was never challenged. The pickets remember the hull that would not answer. That memory is in the log — see the Court. |
| However it went with Skell | Skell landed first — and his first sale to the court was the crew's biography: their debts, their record at Vesta-9, his own edit of the lane ambush. Everything the court knows about the crew, Skell priced. Correcting the record is the crew's problem now, and the court enjoys watching them try. |
| However the Record went | Breck has read the Vesta-9 certificate — the Admiralty reads everything that touches its road — and she opens with it. Truth-tellers get trust; clean-certifiers get a knowing pause and a slightly *better* offer. Founding papers follow you. |
...
> "This is the Anchorage of Sorulba. Enarc is open to you. Enarc is not open *behind* you — the Anchorage keeps what it is given. Dock and be welcome, guests of the court; or come about now, and carry your business back into the dark. There is no third reading. The dark does not care which."

The warning is genuine, delivered once, and phrased so that gold-rush crews have ignored it all week. If the players hesitate, let them — entering *knowing* is the choice the scene is for. The prize, the picket log, and everything else this session wants are on the far side of that door.

**Then the court decides to be delighted.** Whatever business they state, the answer comes back an hour later in a different voice — younger, silkier (Jeeda's office): the court of Enarc *welcomes* the celebrated relighters of Vesta-9 as guests of the Anchor. Berthing is free. Fuel is a gift. Each crew member is assigned a **host** — a courtier-minder who will not leave their side, takes notes behind their smile, and answers every question with a better meal. This is the hermit kingdom's oldest trick: the door does not open; it *swallows*. And on the dock, the crew gets their first taste of Skell's head start — their minders already know things about them: the lease, the impound, a version of the lane ambush with the guns pointing the other way. *(Everything the court knows, Skell sold — see the carry-forward row. Let the players discover the dossier by being complimented on details they never mentioned.)*
...
**Run the festival as one braided scene** — the crew at the center table, three threads arriving over the courses:
...
- A dock family petitions for an **exit permit** — grown children, a cousin on Kalarba, a life waiting. Vopp grants it warmly… effective *after* their debts to the crown clear. The family bows and files out. Everyone in the room knows the debts never clear. *(This is the kingdom in one exchange.)*
- A picket captain reports the week's **ghost sightings** — unidentified transits crossing the far sky — and is thanked and dismissed. *(Seed the log before the crew ever asks about it.)*

**What the courts want** — the argument the crew has walked into the middle of:

| | @@npc:Sorulba the Anchor@@ *(through Vopp)* | @@npc:Jeeda the Younger@@ | Purser-Lt. Breck *(the Admiralty)* |
|---|---|---|---|
| **Wants** | The beacon dark and the kingdom closed. He offers the crew **2,000 scrip, a black-lane rutter — and the rarest paper he signs: exit visas, the whole crew, unconditional** — to certify the corridor "unnavigable" and carry a flattering story of the Anchorage away with them. | The beacon lit, the certificate naming the kajidic **port authority of record** — the kingdom opened *on the family's terms*, fees legal and posted. Offers fuel at cost, clan protection on the Run, "a point of the port, for a year." | The beacon lit with two clauses on the founding paper: a **naval customs house** and **protected-lane status** — settlers and trade welcome, under the fleet's law. Offers escort, fuel at naval rates, naval certification. |
| **Lever** | The palace guard, the pickets, the berth the crew's ship sits in — and every kind hospitality, which in this kingdom is also the cage. | The schedules and the scales: she can make the relight *easy* — leave, power, escorts — or make the king's obstruction visible to the whole clan network he pretends not to fear. | The kingdom's one foreign account: the embassy, the fuel contract, and a patrol sloop a short jump down the Naboo lane. Paper that looks reassuringly like law. |
| **Red line** | A relight certified around him. He does not rage; he *closes the door* — and the crew is on the inside of it. | Violence against the family. Her whole play is that the numbers work without a war. | The junction under *Hutt* law. She smiles through everything except "port authority of record: the kajidic." |
| **Honest warning** | His offers are real and his word is good — that is what makes him dangerous. | "My elders are not evil, wayfinder — they are innumerate." She means it, and she is *twenty percent* less safe than she sounds. | Her tariffs are genuinely low, and every clause is a foothold: the customs house is the Annexation wearing courtesy. |

**The Scales of the Anchor.** Offers at this court are weighed — a token on each pan, before the room — and what is said at the Scales *is* the negotiation. When the crew is called, Vopp sets the king's 2,000-scrip token on his pan and asks, for the record, what the guests put on theirs. Make the players speak their offers aloud; the court grades the performance as much as the terms.

**The King's Circuit — the wager.** The court's obsession, its bread and circuses, its one export-quality thing: **swoop racing** through the palace-city — the bowser colonnades, the dead-dock tunnels, the spine. The thing the crew should want from this room is the **picket log** (below), and Sorulba does not sell it. He *stakes* it — on his champion. If the crew wants the log, someone rides: the court's champion **Draz** (borrow Swoop Ace "Kettle" Maro's block; the kingdom lends the crew a court swoop, tuned exactly as well as the king wishes) against the crew's rider, three legs:
...
@@action:fragment {"name":"The Enarc picket log, dark years","form":"ledger","tag":"Civic","question":"Who lit Vesta-9?","claim":"the pickets stopped hailing the ghosts six years ago — by standing order","holder":"crew","status":"trusted"}@@
...
**Getting leave (or not).** With a court's blessing — Jeeda's, Breck's clauses, a Scales bargain, or a race victory the king honors through his teeth — the crew works openly, with power and dock access, in front of the whole kingdom. Without leave it is an infiltration of a sealed palace whose only guarded relic is the mast: vents, borrowed livery, a festival for cover — build it from the party's ideas, and remember @@npc:Kajidic Enforcers@@ carry Vigilance and Perception as group skills; the smart way past palace muscle has always been the ledger, not the knife.

**The three stations** — one or more PCs each; everyone gets their hands on the beacon:

| Station | Where | The work | On a Despair |
|---|---|---|---|
| **The mast head** | Two hundred meters up the palace spine, EVA, pickets sweeping | **Hard Athletics or Coordination** to make the climb, then **Average Mechanics** to seat the igniter by hand | The tool drifts. Somebody improvises, or somebody goes and gets it — narrate the long reach over nothing. |
...
|---|---|
| 2 Threat | The crown cuts power "for the festival" — the feed junction must re-succeed before the sequence can complete. |
| 3 Threat | Kollen appears at the core room "to assist" — his presence upgrades the next check there once, and if the crew accepts the help, his signature is on the relight paperwork forever (a poison gift the Founding wing will spend). |
...
> The charge runs up the spine like something remembering how to breathe, and the mast catches — light rolling joint by joint to the head, forty years of polish finally meaning something. Below you the whole kingdom has stopped: dock families, courtiers, the palace guard, two Hutts, an envoy in navy grey, every upturned face lit the same color. And on every band, in the oldest voice in the sky, Enarc says its own name to the galaxy — the door the king kept shut, open — *because you lit it.* First light anyone here ever gave back.
...
| Lights it **covertly** and runs | The prize claim is contestable, every court is insulted, and the certificate carries no authority at all | A lit junction with no law: pirates, claim-jumpers, and every faction's worst instinct arrive over the following weeks. The crew built a gold rush with no sheriff — inside somebody's home. |

@@action:clock {"faction":"Kajidics","delta":1,"note":"Enarc forces the family argument — the old king and the young reformer now have a beacon between them"}@@

*If the relight certifies (any lit outcome), update the board:*

@@action:beacon {"name":"Enarc","status":"lit","corridor":"the Run toward Aquilaris — plus the Naboo lane, and the Triellus","certified":"per tonight's paper — note whose authority the certificate names","fee":"witness fees per charter; the 8,000 posted prize per the guild's terms","followed":"the kingdom was already here; note who arrives next"}@@

**The coup — "The Anchor Slips."** The players can topple the king *tonight*, and the module should let them: a hermit reign that rests entirely on a shut door is at its weakest the night the door is being argued over. Sorulba's throne stands on four pillars, and every one of them is already in play somewhere in this module — the coup is not a new scene, it is the night's scenes *aimed*:
...
**What it pays.** The kingdom opens *tonight*, on the crew's hinge — with their names on the founding paper as the witnesses who stood in the court when the anchor slipped. Exit visas for everyone on the guest docks, unconditional. A patron who owes them a throne. And the picket log's second page, in their hands, naming who paid the court to look away — **rung-one Ladder material**, filed by a Hutt court that now has a reason to file it.

**Sorulba, after.** Alive, a creditor, and patient — the one art he has. He does not rage. He *remembers*; he is the man who will tell the Republic's accreditation mission, in Act 2, exactly who overthrew a lawful court, and watch them decide whether that was a crime.

@@action:clock {"faction":"Kajidics","delta":2,"note":"The Anchor slips — Jeeda's coup, backed by the crew: the kingdom opens on the family's terms and the clan war is scheduled"}@@

@@action:thread {"ledger":"debts","who":"Jeeda the Younger","whom":"The crew","what":"A throne — they stood in the court when the anchor slipped","status":"open"}@@
...
@@action:fragment {"name":"The stranded warden's audit slate","form":"sealed Vigil audit","tag":"Civic","question":"Who lit Vesta-9?","claim":"the treasury's seal is intact, and crates still came out of it — on festival nights, six years ago","holder":"crew","status":"trusted"}@@
...
**The wrinkle.** Years ago an Inheritor **Lore-Clerk** entered the Anchorage to buy grave-goods from the confiscated hoard and was never let out. He is now the court's pet — *the archivist of the door* — cataloguing what every arriving hull carries, in a hand so neat the king shows it to guests. He wears the black under a court sash. He is @@npc:Inheritor Lore-Clerks@@'s print, alone, and very polite.

**What he asks.** To carry *out* a report — theatrically sealed: wax, a sigil, a ribbon — to a dead-drop at the next port up the lane. The presentation is the whole Inheritor style; the contents, if the crew open it (they will), are meticulous, boring surveillance lists: hulls, cargoes, names, dates, and a line the crew will recognize as *themselves*. First taste of the presentation/substance gap — and the crew does Inheritor courier work before they have met the faction. **Court gossip**, if they ask around: the king has sold an exit exactly twice in forty years; one buyer wore grave-robber black and paid in relics.

**The collision, unseen.** The clerk is the stall's best customer — he buys from *Sund & Daughter* whatever the confiscated hoard lets him, and the young woman defers to her father's book on anything that looks genuine. The players may watch this happen from across the festival and it should mean nothing to them tonight. *(GM: this is the week the Inheritors introduce themselves to the real Sith by trying to buy from her — the quiet origin of the culling. She flags him to the whisper network before the festival ends.)*

**Choice:** carry the report (a favor logged with a faction they have not met; the dead-drop is at Aquilaris, module 03), open it (the lists are Civic evidence — the Inheritors watch *everything*), or sell it to Vopp. **Aftermath:** if the door opens and the clerk walks out, he leaves with a decade of catalogues — the Inheritors' best archive — and becomes the faction's face at the Memory Market. If the crew never got him out, he is the culling's *first* body: a lone clerk who had seen too much of a chandler's counter, found dead in the Anchorage the week the Weeding learns the name Sund.

@@action:thread {"ledger":"knows","who":"The Inheritors (via the stuck clerk's catalogues)","what":"Every hull, cargo, and name that entered the Anchorage in a decade — the crew's included","since":"S2","notes":"Sealed with wax and ribbon; the contents are surveillance"}@@

@@action:thread {"ledger":"knows","who":"The true Sith line (Odri Sund's whisper network)","what":"An organized, theatrical buyer of Sith material exists — the Inheritors — and shops at her counter","since":"S2","notes":"The quiet origin of the culling; the line did not know they existed before this week"}@@
...
- **Up the Run: Aquilaris, hop 2** — drowned resort world, first of the deep-Run stops, and the guild's next prize posts immediately. *Of course it does.* (This is the patron's order. Staying on it, the crew's luck stays strangely good.)
- **Down the Naboo lane:** Breck extends an invitation — come see the Admiralty's home waters. Seeing the closed pocket from inside is a reveal nobody else on this side of the dark has had. (GM: leaving the patron's order has a felt cost — the unearned luck stops, and the guild's warmth cools a degree.)
- **The Triellus:** Jeeda offers a black-lane rutter and an introduction — the Hutt ring, the family's roads, the wider clan-economy the old king hid from. Same cost: off the order, off the luck.
...
- **If the Admiralty finding exists** (Session One): the tender arrives at Enarc on schedule, and the junction becomes the Annexation's first test case with the crew's names in its founding file.
